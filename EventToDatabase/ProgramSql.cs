...
{
    internal class ProgramSql
    {
        private static readonly string _conStr = ConfigurationManager.ConnectionStrings["sqlconn"].ConnectionString;
        private static readonly string _dir = ConfigurationManager.AppSettings["dir"];
        private static void MainSql(string[] args)
        {
            StartWork();
            //Console.ReadLine();
        }
